...
class NLL(Layer):
    ...
    def getZ(self, N, Z_idx, min_Z, max_Z):
        ...
        # Ref: https://www.tensorflow.org/api_docs/python/tf/sparse/SparseTensor
    ...
    def custom_loss_lm(self, y_true, y_pred, Z_idxs):
        ...
        _, loss1 = tf.linalg.slogdet(V) # is slogdet necessary? shouldn't the covariance matrix be positive definite? -MW
